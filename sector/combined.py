...
class RadialUtilResult:
    """Authoritative applied-ray selection evidence."""
...
def radial_util_result(mx, my, ax, ay):
    """Intersect an applied ``(Mx, My)`` ray with the plastic M-M envelope.
    ...
    Returns the exact demand, intersection resistance, utilisation and governing
    swept-point index. Resistance and member are ``None`` when no usable forward
    intersection exists.
    """

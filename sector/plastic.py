...
def _accumulate(concrete, bar_materials, tendon_materials, dx, dy, s_max, c, phi,
    ...
    Returns compression/tension totals, per-material net resultants, and extreme
    reinforcement strains. Forces are in kN, moments in kNm, and strains use the
    solver's compression-positive convention.

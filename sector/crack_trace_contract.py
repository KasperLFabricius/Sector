"""Frozen CT-009 contract for the EN 1992-1-1:2004 base crack branch."""
...
def registry_for(members: tuple[MemberShape, ...]) -> TraceRegistryContract:
    """Return the exact ordered family, graph, role, and source contract."""
    ...
    return TraceRegistryContract(
        REGISTRY_ID,
        (TraceFamilyContract(FAMILY_ID, rows),),
    )

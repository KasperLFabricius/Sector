...
Current internal version: **Sector 0.96.2**. See [CHANGELOG.md](CHANGELOG.md) and
the [v0.96.2 release notes](docs/v0962_release_notes.md).
...
`BUILD.bat` creates `Sector-v0.96.2-windows-portable.zip` and a SHA-256 sidecar.

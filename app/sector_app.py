        ...
        out["plastic"] = dict(
            ...
            points=[
                dict(
                    ...
                    Mx=p.Mx,
                    My=p.My,
                    na_x=p.na_x_intercept,
                    na_y=p.na_y_intercept,
                    eps_c=-p.eps_concrete,
                    eps_s=-p.eps_steel,
                    eps_s_comp=-p.eps_steel_comp,
                    eps_cable=-p.eps_cable,
                    kappa=p.curvature,
                    axial=p.axial,
                    axial_action=-p.axial,

...
_CONTRACTS: dict[tuple[str, str | None], EquationContract] = {
    ...
    ("basis.fatigue.stress-range", None): _relation(
        ...
        ("sigma", "stress calculated for the stated section-action state", "MPa"),
    ...
    ("fatigue.reinforcement.design-stress-range", None): _result(
        ...
        ("eta<sub>b</sub>", "selected bond stress-range adjustment factor"),
    ...
    ("fatigue.reinforcement.sn-life", "power-law"): _result(
        ...
        ("k", "S-N curve exponent for the selected curve branch"),
        applicability_note_required=True,
    ),
    ...
    ("fatigue.reinforcement.yield-limit", None): _result(
        ...
        (
            "f<sub>yk/proof</sub>",
            "characteristic yield or proof strength for the selected material law",
            "MPa",
        ),
    ...
    ("fatigue.concrete.life", "variable-compression"): _result(
        ...
        ("C", "concrete fatigue-life coefficient for the stated stress ratio"),
        ("E<sub>cd,max</sub>", "normalized maximum design concrete stress"),
    ...
    ("fatigue.concrete.utilisation", None): _result(
        ...
        (
            "u<sub>bound</sub>",
            "conservative fatigue-utilisation bound from the concrete-fibre search",
        ),
        applicability_note_required=True,
    ),
    ...
    ("detailing.minimum.nominal-equilibrium-2023", None): _result(
        "Delta N", "kN",
        ("Delta N", "final nominal-section axial residual", "kN"),
        ("N<sub>int</sub>", "calculated internal nominal axial force", "kN"),
    ...
    ("plastic.worked.strain-plane", None): _result(
        ...
        ("eps<sub>0</sub>", "converged strain-plane offset"),
        ("g<sub>x</sub>", "converged strain gradient in x", "1/m"),
        ("g<sub>y</sub>", "converged strain gradient in y", "1/m"),
    ...
    ("plastic.worked.curvature-candidate", None): _result(
        ...
        ("eps<sub>lim,i</sub>", "material strain limit for candidate i"),
    ...
    ("plastic.worked.element-force", None): _result(
        ...
        ("sigma<sub>i</sub>", "calculated material stress of element i", "MPa"),
    ...
    ("elastic.long.stress-plane", None): _result(
        ...
        ("sigma<sub>0</sub>", "converged reference-stress offset", "kN/m2"),
        ("g<sub>x</sub>", "converged reference-stress gradient in x", "kN/m3"),
        ("g<sub>y</sub>", "converged reference-stress gradient in y", "kN/m3"),
        ("x", "section x-coordinate", "m"),
        ("y", "section y-coordinate", "m"),
    ),
    ...
    ("elastic.long.equilibrium-n", None): _result(
        ...
        ("J", "final transformed-section equilibrium row", "mixed section units"),
        ("q", "converged reference-stress plane", "mixed stress units"),
        ("target", "applied axial resultant", "kN"),
    ...
    ("elastic.long.equilibrium-mx", None): _result(
        ...
        ("J", "final transformed-section equilibrium row", "mixed section units"),
        ("q", "converged reference-stress plane", "mixed stress units"),
        ("target", "applied moment resultant", "kNm"),
    ...
    ("elastic.combined.target-n", None): _result(
        ...
        (
            "N<sub>neu</sub>",
            "neutralising axial resultant used in the combination",
            "kN",
        ),
    ),
    ("elastic.combined.target-mx", None): _result(
        ...
        (
            "M<sub>x,neu</sub>",
            "neutralising moment used in the combination",
            "kNm",
        ),
    ),
    ...
    ("elastic.combined.total-stress", None): _result(
        ...
        ("sigma<sub>total,i</sub>", "combined total element stress", "MPa"),
        ("sigma<sub>s2,i</sub>", "reduced passive long-term stress", "MPa"),
    ...
    ("crack.heightened.area-comparison", None): _result(
        ...
        (
            "A<sub>s,prov</sub>",
            "provided mild-reinforcement area used in the ordinary crack calculation",
            "mm2",
        ),
        applicability_note_required=True,
    ),

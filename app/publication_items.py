...
MANUAL_FIGURE_SPECS = (
    ManualFigureSpec("Part A - Get started", "Quick start", "fig_workspace_overview",
                     'Workspace overview (schematic): prepare inputs, calculate and review named results, then publish.',
...
MANUAL_TABLE_SPECS = (
    ...
    ManualTableSpec("Part A - Get started", "Task workflows",
                    ("Task", "Outcome"),
                    "Task index and intended outcomes"),
    ManualTableSpec("Part A - Get started", "The worked examples",
                    ("Named variant / calculation", "Section and materials", "Actions / changed assumptions"),
                    "Named worked examples and changed assumptions"),
    ...
    ManualTableSpec("Part B - Features & options", "Loads",
                    ...
                    "Concrete corner points - field reference"),
    ManualTableSpec("Part B - Features & options", "Loads",
                    ("Field / unit", "Meaning / sign", "Default / validation"),
                    "Concrete void points - field reference"),
    ManualTableSpec("Part B - Features & options", "Loads",
                    ("Field / unit", "Meaning / sign", "Default / validation"),
                    "Reinforcing bars - field reference"),
    ManualTableSpec("Part B - Features & options", "Loads",
                    ("Field / unit", "Meaning / sign", "Default / validation"),
                    "Prestressing tendons - field reference"),
    ManualTableSpec("Part B - Features & options", "Loads",
                    ("Field / unit", "Meaning / sign", "Default / validation"),
                    "Plastic and capacity cases - field reference"),
    ManualTableSpec("Part B - Features & options", "Loads",
                    ("Field / unit", "Meaning / sign", "Default / validation"),
                    "Elastic cases - field reference"),
    ManualTableSpec("Part B - Features & options", "Loads",
                    ("Field / unit", "Meaning / sign", "Default / validation"),
                    "Grouped fatigue spectrum - field reference"),
    ManualTableSpec("Part B - Features & options", "Reading the results",
                    ("Status", "Meaning", "Next action"),
                    "Result status meanings and next actions"),
    ManualTableSpec("Part B - Features & options", "Reading the results",
    ...
    ManualTableSpec("Part C - Theory & methodology", "Serviceability: cracking and crack width",
                    ("Crack-width edition", "Crack spacing (mm)", "$h_{c,ef}$ (m)", "$w_k$ (mm)"),
...
MANUAL_TABLE_CONTENT_SHA256 = (
    ...
    "4042b256aaff587797a4a971335dd59f83aa62eb561fb2096b94b1535b78026a",
    "bdabad7722151629df854716565a7f888ad209c8808068b918d0e2c1cde608b7",
    ...
    "c44e9dafbd76fbb9d899f75f6c871b8bcc13efecfe682cd38785b49ac37acf05",
    "7626d90edb81ce4dad70867b5573a36e1ff97730314b6cdd74297084eef78f9c",
    "058bbbe1b97f1e6378d0fe2e3adf29d6054012f9760ecfc33a08e48e1b519982",
    "058bbbe1b97f1e6378d0fe2e3adf29d6054012f9760ecfc33a08e48e1b519982",
    "d56da2ca777675cecd5f374dbeb2da15046362b77a9f6d38ffd100a0802802e4",
    "a70d985f60c2213954513e4f3d95a52fc986d47d3c5b0c558ebf736c6b22f5ac",
    "efb06e99418d8c13f51830f4e04838c0e268a0c448290537a1116056454f59bc",
    "dc57858f6a546cddb91946d8e7d78b5b356fbbb3281ed72f43d8013bb2101dcc",
    "d12551db44524b46cf5be925a44ff1e46cb02912ce96cd878bad7e2504b0c683",
    "4cc94b96d11ef3740ac3ae53f5884d82df6013fc66acb8ff3750827739fadbb2",
    "a4ab7c081133816dfe56e900c0eefd504edf086159b29fd2ab5dc89c841fed6f",
    "0983c6e55bb7b8362d84908e942e1917eaf516c67844767ce7a6138caf6286e5",
    "df127ca9ddb602806032e01ec9fe5ba32a37171c4071c8a275b08018981bb446",
    "74ee57c418168df35355bd426c2966bb59d9222e5aee071e186d0a1b95620b49",
    "62a58fd92caebabf1711340262c71c619808090ca0a1236a59b965921b1076c9",
    "d1c94eeff8b5a96c89ecf1e67f7127634e9e5fb3fd67027475ee753ee5d6371f",
    "c2942f954a35fe8a8908b6612913f5927a74dcb7ae021a36827296b9ebcac360",
    "3c1d4d27cc21e328704d6bb0a7a39209dcf66e94c7d94dc8aca4f9e460faa01b",
)

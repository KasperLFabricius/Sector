...
def test_build_wrapper_resolves_python_and_delegates_once():
    ...
    assert 'Write-Host "Sector v0.96.1 portable Windows build"' in script
...
def test_user_documentation_describes_the_actual_small_output():
    ...
    assert """Sector-v0.96.1-windows-portable/
Sector-v0.96.1-windows-portable.zip
Sector-v0.96.1-windows-portable.zip.sha256""" in readme

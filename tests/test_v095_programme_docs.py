    ...
    expected = [
        ...
        (
            ...
            (
                ...
                "stress and strain evidence while coordinates remain in input "
                "previews."
            ),
            ["PR-A07"],
        ),
        ...
        (
            "OA095-008",
            (
                "Publish retained plastic compression-zone depth c without relabelling "
                "it as generic effective reinforcement depth d."
            ),
            ["PR-A09"],
        ),
        (
            ...
            (
                ...
                "while retaining its generator, oracle, fixture and tests as QA "
                "assets."
            ),
            ["PR-A10"],
        ),

...
| D093-026 | The decision register is also delivered as a verified Excel workbook. | The workbook mirrors these IDs, includes programme ownership and acceptance columns, uses filters/frozen headers and carries a generation note tying it to an exact Git revision. | Workbook formula/error inspection plus rendered sheet review. | PR-01 follow-up and PR-09 |

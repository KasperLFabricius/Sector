# PR-A04 v0.95 dual user-owned crack-width criteria acceptance

## Exact boundary

- Exact base: `9679df947ffed1ab65893de916c442323ec4d4b9`.
- Base tree: `157e18ed9d674105caae290162effdcf192f0999`.
...
- Dependency: PR-A00b is merged and freezes this outcome and PR-A04 as its
  acceptance owner.
...
- Results, Standard/Audit/Brief report, fixture and manual controls for distinct
  duration wording and omission of global-verdict language; and

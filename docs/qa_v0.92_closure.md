...
- The first Codex Review on
  ...
  All are locally remediated. New exact-head Codex Review, GitHub CI, original
  independent QA closure and merge remain pending; this implementation log does

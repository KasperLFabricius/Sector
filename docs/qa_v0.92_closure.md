...
| F-002 | PR-07 reset | Corrective implementation; independent re-closure pending | Torsional cracking uses a distinct direct positive-finite `gamma_ct` input rather than `gamma_c`; EN starts at 1.50 and DK/NA at 1.70, with custom values retained without approval or authority routing. | 300 x 600 mm C35 tube (`Ak=0.1 m2`, `tef=100 mm`): DK/NA `gamma_ct=1.70` gives `T_Rd,c=26.4349848 kNm`; the rejected `gamma_c=1.45` path gave `30.9927408 kNm`. | Focused core default/custom/invalid and demand-between-threshold regressions; current-schema round trip and rejection; Streamlit freshness/default/custom path; report provenance. | Exact corrective head and review are tracked on PR #210; rejected head `f98130b8091f08fa024d8224cbc3ea6542bdd110` is not accepted. | Pending | Pending | No `gamma0`/`gamma3`, approval, category, authority or legacy-migration route is restored. |

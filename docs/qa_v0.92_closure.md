...
- Scope: F-003, F-007 and F-008 only.
...
- Pre-immutable-head gates are green: 21 focused PR03 tests, 316 affected
  ...
  708.08 s with the expected
  32 Kaleido warnings and no failures.
- Fresh generated evidence passed structural and raster preflight:
  ...
  and crack scope/provenance on page 30) and
  `sector-manual-reference.pdf` (32 pages; the 2023 method and applicability
  scope on pages 23-24). A fresh source-tree browser walkthrough on
...
- Codex Review, GitHub CI, original independent QA closure and merge are

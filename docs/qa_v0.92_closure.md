...
- Exact corrective SHA, current-head Codex rereview, the single completed
  ...
  corrective-head CI runs are superseded and are not counted as the required
  exact-head gate.

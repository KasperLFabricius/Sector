# PR-14C4 consolidated publication acceptance
...
Every external action remains pinned to a full commit. QA evidence retention is
14 days and dual-build evidence retention is 7 days. The ordinary QA workflow
contains no secret or signing authority and never launches an unsigned package.
The manual protected-release workflow and its sole secret-bearing signing step
remain independently guarded by the accepted PR-14A/C policies.

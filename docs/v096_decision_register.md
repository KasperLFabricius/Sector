...
| D096-005 | Keep Results Overview fully visible and governing-family based. | One row per stable check family; no fixed-height vertical scroll and no per-case conclusion list. | Semantic and Streamlit presentation tests. | PR-02 |

...
| `../tools/build_exact_commit.py` | Standard-library driver: exports exact source, fixes the source epoch and PyInstaller build hash seed, installs its hashed lock, generates notices, builds, and performs create-only assembly. |
